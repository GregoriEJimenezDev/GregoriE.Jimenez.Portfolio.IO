...
const SkillsList = () => {
  ...
  const skills = {
    "¿Qué tecnologías uso?": [
      "Actualmente trabajo con tecnologías como React, Next.js, Vue.js, Astro, tailwind, Boostrap y demas librerias y frameworks para el full-stack y en el backend trabajo con Node.js, Express, MongoDB, Firebase, entre otras.",
    ],
    "Mi Experiencia": [
      "Tengo experiencia trabajando en startups y consultoras tecnológicas, desarrollando y maquetando sitios web a partir de diseños en Figma. Para ello, utilizo tecnologías full-stack como Astro y React, junto con Tailwind CSS y otras librerías y frameworks para el estilizado y la optimización de interfaces.",
    ],
    "Mi formacion": [
      "Estudié una tecnicatura en automatización de grado universitaria en el ITU, lo que me brindó las bases en programación. Posteriormente, decidí enfocarme en el desarrollo .net escritorio y de software. Ademas, realicé diversos cursos, diplomados y capacitaciones en grandes universidades Argentinas, como la UTN, tambien, complemento mi formación con el aprendizaje autodidacta, lo que me permite mantenerme actualizado con los avances tecnológicos en el desarrollo de software.",
    ],
    "¿Cómo trabajo en equipo?": [
      "Tengo experiencia trabajando en equipos multidisciplinarios, donde me he encargado del desarrollo full-stack de aplicaciones web. Para ello, utilizo metodologías ágiles como Scrum y Kanban, además de herramientas de control de versiones como Git y GitHub para gestionar el flujo de trabajo. También cuento con experiencia en el uso de herramientas de gestión de proyectos como Trello y Jira, facilitando la organización y colaboración dentro del equipo.",
    ],
    "Metodolgias Agiles": [
