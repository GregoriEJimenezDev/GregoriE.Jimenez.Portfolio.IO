export const jobs = [
  {
    title: "Full-Stack Developer - Neowyze",
    time: ["12/2024 - 05/2025"],
    description:
      "Mis tareas en Neowyze consisten en desarrollar webs responsivas basadas en diseños proporcionados en Figma, utilizando Astro, React, Tailwind y otras librerías full-stack.",
    list: [
  ...
  {
    title: "Full-Stack Developer - Vegna",
  ...
  {
    title: "Full-Stack Developer - Igrowker",
  ...
  },
  {
    ...
    list: [
      "Full-Stack : React - React Router - Context api - tailwindcss",
